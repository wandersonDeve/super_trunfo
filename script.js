...
var cartaSuper = {
    nome: "Tecnico",
    imagem: 'https://i.giphy.com/media/Ey140ukGA1fjO/giphy.webp',
    atributos: {
        ataque: 100,
        defesa: 100,
        magia: 100
...
var cartaMaquina
var cartaJogador
var cartas = [cartaPegaso, cartaVader, cartaLol, cartaNaruto, cartaHarry, cartaBatman, cartaMarvel, cartaSuper]
...
function exibeCartaJogador() {
    ...
    if (cartaJogador.nome != 'Tecnico' && cartaMaquina.nome != 'Tecnico'){
...
function jogar() {
    ...
    if (cartas.length == 0){
      ...
      if (pontosJogador > pontosMaquina){
        ...
        htmlResultado = '<p class="resultado-final">INFELIZMENTE A MAQUINA GANHOU</p>'
      }
      else {
        htmlResultado = '<p class="resultado-final">DESSA VEZ SAIU EMPATE</p>'
      }
    } else {
